...
export const seedSettings: StoreSettingsView = {
  ...
  locationEn:
    "Damascus, Syria. Delivery details are confirmed through WhatsApp.",
  whatsappTemplateAr: "",
  whatsappTemplateEn: "",
};
...
export const seedCategories: CategoryView[] = [
  {
    ...
    descriptionEn:
      "Daily lightweight pieces with straight cuts and essential colors.",
    imageUrl: "/brand/category-image-1.jpg",
    isVisible: true,
    sortOrder: 1,
  },
  {
    ...
    imageUrl: "/brand/category-image-2.jpg",
    isVisible: true,
    sortOrder: 2,
  },
  {
    ...
    imageUrl: "/brand/category-image-3.jpg",
    isVisible: true,
    sortOrder: 3,
  },
];
...
export const seedProducts: ProductView[] = [
  {
    ...
    images: [
      {
        id: "img-stone",
        url: "/brand/category-image-1.jpg",
        altAr: "تي شيرت ستون",
        altEn: "Stone tee",
        isMain: true,
        colorId: "color-stone",
      ...
      {
        id: "img-charcoal",
        url: "/brand/category-image-4.jpg",
        altAr: "تي شيرت فحمي",
        altEn: "Charcoal tee",
        isMain: false,
    ...
    colors: [
      ...
      },
      {
        ...
        nameEn: "Charcoal",
        hex: "#282824",
        imageUrl: "/brand/category-image-4.jpg",
        isAvailable: true,
        sortOrder: 2,
        variants: ["M", "L"].map((size) => ({
          id: `v-charcoal-${size}`,
          colorId: "color-charcoal",
          size,
          isAvailable: true,
  ...
  },
  {
    ...
    descriptionAr:
      "هودي ناعم بلون كريمي، جيب أمامي، وقصة متوازنة للأيام الباردة.",
    descriptionEn:
      "A soft cream hoodie with a front pocket and balanced fit for cooler days.",
    ...
    images: [
      {
        id: "img-hoodie",
        url: "/brand/category-image-2.jpg",
        altAr: "هودي كريمي",
        altEn: "Cream hoodie",
        isMain: true,
        colorId: "color-cream",
  ...
  },
  {
    ...
    descriptionAr:
      "تي شيرت بلون زيتوني مطفي، مناسب للتنسيق مع الدنيم والجاكيتات.",
    descriptionEn:
      "A muted olive tee that works cleanly with denim and light jackets.",
    ...
    images: [
      {
        id: "img-olive",
        url: "/brand/category-image-5.jpg",
        altAr: "تي شيرت أوليف",
        altEn: "Olive tee",
        isMain: true,
        colorId: "color-olive",
    ...
    colors: [
      {
        ...
        nameEn: "Olive",
        hex: "#6b6b54",
        imageUrl: "/brand/category-image-5.jpg",
        isAvailable: true,
        sortOrder: 1,
  ...
  },
  {
    ...
    images: [
      {
        id: "img-jacket",
        url: "/brand/category-image-3.jpg",
        altAr: "جاكيت إنك",
        altEn: "Ink jacket",
        isMain: true,
        colorId: "color-ink",
